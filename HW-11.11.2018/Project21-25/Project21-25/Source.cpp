/*1) Метод, выписывающий наименование дня недели по дате.
2) Метод, определяющий, сколько дней осталось до Нового Года.
3) Оператор минус, возвращающий, количество дней прошедших между датами.
4) Оператор плюс, принимающий целое число дней и возвращающий дату,
отстоящую на это количество дней.
5)Метод, находящий следующую дату - палиндром.*/
#include <iostream>
using namespace std;
...
int main() {
	...
	cout << endl;
	cout << First.new_year() << " days left until New Year" << endl;
	Date Second;
	cout << "Enter the second date: " << endl;
	Second.input();
	cout << "Between them " << (First - Second) << " days" << endl;
	int n;
